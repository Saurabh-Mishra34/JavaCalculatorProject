...
import javax.swing.*;//Java AWT (Abstract Window Toolkit) is an API to develop GUI or window-based applications in java.
import java.awt.*;
import java.awt.event.*;

public class calculator implements ActionListener{

	JFrame frame; // The Java Swing JFrame class is the foundation for creating graphical Java applications. Without the frame, you can't perform any interactions. When you create a new instance of the JFrame, you can pass a title to the constructor or simply create an empty frame.
